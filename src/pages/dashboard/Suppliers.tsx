        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage vendor relationships and track payables
            </p>
          </div>
          <Button>
        ...
        <Card>
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell className="font-medium">SUP-001</TableCell>
                  <TableCell>Tech Solutions Ltd</TableCell>
                  <TableCell>contact@techsolutions.com</TableCell>
                  <TableCell>+27 11 123 4567</TableCell>
                  <TableCell>R5,250.00</TableCell>
                  <TableCell>

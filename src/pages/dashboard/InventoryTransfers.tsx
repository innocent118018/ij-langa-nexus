    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Track inventory movement between locations and warehouses
            </p>
          </div>
          <Button>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Inventory Transfers Overview</CardTitle>
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell className="font-medium">IT-001</TableCell>
